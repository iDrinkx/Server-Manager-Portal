...
Object.assign(ru, { homeDashboard: { ...ru.homeDashboard, nowPlayingCompanion: { ...ru.homeDashboard.nowPlayingCompanion,
    sections: { ...ru.homeDashboard.nowPlayingCompanion.sections, storySnapshot: 'Краткий обзор сюжета' }, overview: { show: 'О сериале', movie: 'О фильме', season: 'Обзор сезона {season}', episode: 'Эпизод S{season}E{episode}', episodeWithName: 'Эпизод S{season}E{episode}: {name}', readMore: 'Подробнее', readLess: 'Свернуть', unavailable: 'Для этого названия пока нет описания.' }, crew: { popularity: 'Популярность {value}', otherRoles: 'Другие роли в этом проекте: {roles}', productionSnapshot: 'Сводка производства', moreCrew: 'Больше участников команды', networks: 'Сети' }, header: { ...ru.homeDashboard.nowPlayingCompanion.header, playbackProgress: '{mediaType} · просмотрено {progress}%' }, summary: { progress: 'прогресс: {progress}%', throughSession: 'Просмотрено {progress}% этой сессии' },
} } });
