...
Object.assign(ru, { navigation: { home: 'Главная', users: 'Пользователи', dashboard: 'Панель', status: 'Статус', logs: 'Журналы', analytics: 'Аналитика', achievements: 'Достижения', support: 'Поддержка', chat: 'Чат', downloads: 'Загрузки', calendar: 'Календарь', cleaner: 'Очистка', upgrader: 'Апгрейдер', collexions: 'ColleXions', spotifySync: 'Spotify Sync', scanner: 'Сканер', mediaAutomation: 'Автоматизация медиа', posterSets: 'Наборы постеров', overlays: 'Оверлеи', editions: 'Издания', requests: 'Запросы', discoverRequest: 'Поиск и запрос', request: 'Запрос', about: 'О портале', preferences: 'Предпочтения', profile: 'Профиль', settings: 'Настройки', logout: 'Выйти', more: 'Ещё', moreMenu: 'Меню «Ещё»' } });
