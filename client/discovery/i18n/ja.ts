...
Object.assign(ja, { navigation: { home: 'ホーム', users: 'ユーザー', dashboard: 'ダッシュボード', status: 'ステータス', logs: 'ログ', analytics: '分析', achievements: '実績', support: 'サポート', chat: 'チャット', downloads: 'ダウンロード', calendar: 'カレンダー', cleaner: 'クリーンアップ', upgrader: 'アップグレーダー', collexions: 'ColleXions', spotifySync: 'Spotify Sync', scanner: 'スキャナー', mediaAutomation: 'メディア自動化', posterSets: 'ポスターセット', overlays: 'オーバーレイ', editions: 'エディション', requests: 'リクエスト', discoverRequest: '検索とリクエスト', request: 'リクエスト', about: 'このポータルについて', preferences: '環境設定', profile: 'プロフィール', settings: '設定', logout: 'ログアウト', more: 'もっと見る', moreMenu: 'その他のメニュー' } });
