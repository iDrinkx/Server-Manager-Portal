...
Object.assign(ja, { requestsAdmin: { page: { internalFetchHint: '公開リバースプロキシ URL を使用している場合、ポータルのコンテナから到達できないことがあります。設定 → 連携 で内部取得 URL を追加してください（Docker サービス名または LAN IP。例: http://jellyseerr:5055）。' } } });
