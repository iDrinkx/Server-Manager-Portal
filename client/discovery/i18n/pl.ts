...
Object.assign(pl, { homeDashboard: { ...pl.homeDashboard, nowPlayingCompanion: { ...pl.homeDashboard.nowPlayingCompanion,
    sections: { ...pl.homeDashboard.nowPlayingCompanion.sections, storySnapshot: 'Zarys fabuły' }, overview: { show: 'O serialu', movie: 'O filmie', season: 'Przegląd sezonu {season}', episode: 'Odcinek S{season}E{episode}', episodeWithName: 'Odcinek S{season}E{episode}: {name}', readMore: 'Czytaj więcej', readLess: 'Pokaż mniej', unavailable: 'Opis tego tytułu nie jest jeszcze dostępny.' }, crew: { popularity: 'Popularność {value}', otherRoles: 'Również przy tym tytule: {roles}', productionSnapshot: 'Przegląd produkcji', moreCrew: 'Więcej ekipy', networks: 'Sieci' }, header: { ...pl.homeDashboard.nowPlayingCompanion.header, playbackProgress: '{mediaType} · obejrzano {progress}%' }, summary: { progress: 'postęp {progress}%', throughSession: 'Obejrzano {progress}% tej sesji' },
} } });
