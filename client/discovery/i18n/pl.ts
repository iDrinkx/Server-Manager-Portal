...
Object.assign(pl, { requestsAdmin: { page: { pendingSummary: '{count} oczekujących · pełny przegląd w stylu Seerr z profilami, folderami, tagami i sezonami', reviewQueue: 'Kolejka weryfikacji', description: 'Zatwierdzaj lub odrzucaj żądania portalu, obsługuj problemy i zarządzaj listą blokad.', issues: 'Problemy', blocklist: 'Lista blokad', configuredConnectionFailed: 'Aplikacja żądań jest skonfigurowana, ale połączenie nie powiodło się (zobacz poniżej)', connectHint: 'Połącz Seerr, Overseerr lub Jellyseerr w Ustawienia → Integracje, aby zarządzać tutaj żądaniami.', notConfigured: 'Aplikacja żądań nie jest skonfigurowana', notConfiguredHint: 'Ustaw typ aplikacji żądań, URL i klucz API w Ustawienia → Integracje. Ombi nie obsługuje jeszcze zatwierdzania w portalu.', internalFetchHint: 'Jeśli używasz publicznego adresu URL przez odwrotne proxy, kontener portalu może nie mieć do niego dostępu. Dodaj wewnętrzny adres URL pobierania w Ustawienia → Integracje (nazwa usługi Docker lub adres IP sieci LAN, np. http://jellyseerr:5055).', notSupported: 'Typ aplikacji żądań nie jest obsługiwany', notSupportedHint: 'Zatwierdzanie w portalu działa z Seerr, Overseerr i Jellyseerr. Ombi wymaga zewnętrznego interfejsu żądań.' }, filters: { allRequesters: 'Wszyscy wnioskujący', pending: 'Oczekujące', processing: 'W trakcie przetwarzania', available: 'Dostępne', failed: 'Nieudane', approved: 'Zatwierdzone', declined: 'Odrzucone', search: 'Szukaj tytułu lub wnioskującego...', allTypes: 'Wszystkie typy', allQuality: 'Wszystkie jakości', hdOnly: 'Tylko HD', '4kOnly': 'Tylko 4K', allDates: 'Wszystkie daty', last7Days: 'Ostatnie 7 dni', last30Days: 'Ostatnie 30 dni' }, labels: { requestedBy: 'Zażądane przez', updated: 'Zaktualizowano', lastActionBy: 'Ostatnia akcja wykonana przez', seasons: 'Sezony', status: 'Status', created: 'Utworzono', reason: 'Powód', internalFetchUrl: 'Wewnętrzny URL pobierania' }, empty: { noStatusRequests: 'Brak żądań ze statusem {status}', noFilteredRequests: 'Żadne żądania nie pasują do filtrów', allCaughtUp: 'Wszystko jest załatwione.' } } });
