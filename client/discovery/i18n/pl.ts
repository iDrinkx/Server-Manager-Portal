...
Object.assign(pl, { navigation: { home: 'Strona główna', users: 'Użytkownicy', dashboard: 'Panel główny', status: 'Status', logs: 'Dzienniki', analytics: 'Analityka', achievements: 'Osiągnięcia', support: 'Wsparcie', chat: 'Czat', downloads: 'Pobieranie', calendar: 'Kalendarz', cleaner: 'Czyszczenie', upgrader: 'Aktualizator', collexions: 'ColleXions', spotifySync: 'Spotify Sync', scanner: 'Skaner', mediaAutomation: 'Automatyzacja multimediów', posterSets: 'Zestawy plakatów', overlays: 'Nakładki', editions: 'Edycje', requests: 'Prośby', discoverRequest: 'Odkrywaj i proś', request: 'Prośba', about: 'O nas', preferences: 'Preferencje', profile: 'Profil', settings: 'Ustawienia', logout: 'Wyloguj', more: 'Więcej', moreMenu: 'Menu więcej' } });
