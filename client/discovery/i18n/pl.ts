...
Object.assign(pl, { requestsAdmin: { page: { internalFetchHint: 'Jeśli używasz publicznego adresu URL przez odwrotne proxy, kontener portalu może nie mieć do niego dostępu. Dodaj wewnętrzny adres URL pobierania w Ustawienia → Integracje (nazwa usługi Docker lub adres IP sieci LAN, np. http://jellyseerr:5055).' } } });
