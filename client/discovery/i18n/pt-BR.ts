...
Object.assign(ptBR, { navigation: { home: 'Início', users: 'Usuários', dashboard: 'Painel', status: 'Status', logs: 'Registros', analytics: 'Análises', achievements: 'Conquistas', support: 'Suporte', chat: 'Chat', downloads: 'Downloads', calendar: 'Calendário', cleaner: 'Limpeza', upgrader: 'Atualizador', collexions: 'ColleXions', spotifySync: 'Spotify Sync', scanner: 'Scanner', mediaAutomation: 'Automação de mídia', posterSets: 'Conjuntos de pôsteres', overlays: 'Sobreposições', editions: 'Edições', requests: 'Solicitações', discoverRequest: 'Descobrir e solicitar', request: 'Solicitação', about: 'Sobre', preferences: 'Preferências', profile: 'Perfil', settings: 'Configurações', logout: 'Sair', more: 'Mais', moreMenu: 'Menu Mais' } });
