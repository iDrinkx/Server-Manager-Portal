...
Object.assign(ptBR, { requestsAdmin: { page: { pendingSummary: '{count} pendentes · revisão completa no estilo Seerr com perfis, pastas, tags e temporadas', reviewQueue: 'Fila de revisão', description: 'Aprove ou recuse solicitações do portal, faça a triagem de problemas e gerencie a lista de bloqueio.', issues: 'Problemas', blocklist: 'Lista de bloqueio', configuredConnectionFailed: 'O app de solicitações está configurado, mas a conexão falhou (veja abaixo)', connectHint: 'Conecte Seerr, Overseerr ou Jellyseerr em Configurações → Integrações para gerenciar solicitações aqui.', notConfigured: 'App de solicitações não configurado', notConfiguredHint: 'Defina o tipo do app de solicitações, a URL e a chave de API em Configurações → Integrações. O Ombi ainda não é compatível com a aprovação no portal.', internalFetchHint: 'Se você usa uma URL pública por meio de um proxy reverso, talvez o contêiner do portal não consiga acessá-la. Adicione uma URL de acesso interno em Configurações → Integrações (nome do serviço Docker ou IP da LAN, por ex. http://jellyseerr:5055).', notSupported: 'Tipo de app de solicitações não compatível', notSupportedHint: 'A aprovação no portal funciona com Seerr, Overseerr e Jellyseerr. O Ombi requer a interface externa de solicitações.' }, filters: { allRequesters: 'Todos os solicitantes', pending: 'Pendentes', processing: 'Em processamento', available: 'Disponível', failed: 'Com falha', approved: 'Aprovadas', declined: 'Recusadas', search: 'Buscar título ou solicitante...', allTypes: 'Todos os tipos', allQuality: 'Todas as qualidades', hdOnly: 'Somente HD', '4kOnly': 'Somente 4K', allDates: 'Todas as datas', last7Days: 'Últimos 7 dias', last30Days: 'Últimos 30 dias' }, labels: { requestedBy: 'Solicitado por', updated: 'Atualizado', lastActionBy: 'Última ação por', seasons: 'Temporadas', status: 'Status', created: 'Criado', reason: 'Motivo', internalFetchUrl: 'URL de acesso interno' }, empty: { noStatusRequests: 'Não há solicitações {status}', noFilteredRequests: 'Nenhuma solicitação corresponde aos seus filtros', allCaughtUp: 'Tudo em dia.' } } });
