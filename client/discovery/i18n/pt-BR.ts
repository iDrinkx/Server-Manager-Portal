...
Object.assign(ptBR, { requestsAdmin: { page: { internalFetchHint: 'Se você usa uma URL pública por meio de um proxy reverso, talvez o contêiner do portal não consiga acessá-la. Adicione uma URL de acesso interno em Configurações → Integrações (nome do serviço Docker ou IP da LAN, por ex. http://jellyseerr:5055).' } } });
