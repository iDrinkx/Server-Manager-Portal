...
Object.assign(ptBR, { homeDashboard: { ...ptBR.homeDashboard, nowPlayingCompanion: { ...ptBR.homeDashboard.nowPlayingCompanion,
    sections: { ...ptBR.homeDashboard.nowPlayingCompanion.sections, storySnapshot: 'Resumo da história' }, overview: { show: 'Sobre a série', movie: 'Sobre o filme', season: 'Resumo da temporada {season}', episode: 'Episódio S{season}E{episode}', episodeWithName: 'Episódio S{season}E{episode}: {name}', readMore: 'Ler mais', readLess: 'Mostrar menos', unavailable: 'Ainda não há sinopse disponível para este título.' }, crew: { popularity: 'Popularidade {value}', otherRoles: 'Também neste título: {roles}', productionSnapshot: 'Resumo da produção', moreCrew: 'Mais equipe', networks: 'Redes' }, header: { ...ptBR.homeDashboard.nowPlayingCompanion.header, playbackProgress: '{mediaType} · {progress}% assistido' }, summary: { progress: 'progresso {progress}%', throughSession: '{progress}% desta sessão' },
} } });
